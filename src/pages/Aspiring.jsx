      ...
      <div className="container1">
        ...
        <div className="articleCard">
          <div className="articleCardImage">
            <img src="https://womenpreneurme.com/wp-content/uploads/2024/04/article-2.jpeg" alt="Lesia S" />
          ...
          <div className="articleCardContent">
            <h2>Manifestation Formula: Lesia’s inspiring story on how to glow up physically and mentally</h2>
        ...
        <div className="articleCard">
          ...
          <div className="articleCardContent">
            ...
            <a href="#read-more" className='read'>Read More </a>
          </div>
        </div>
      </div>
    </div>
